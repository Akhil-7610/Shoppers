            ...
            {!orderDetails ? (
                ...
                <div className="flex flex-col sm:flex-row justify-between mb-8">
                    ...
                    <div className="flex flex-col items-start sm:items-end mt-4 sm:mt-0">
                        ...
                        <span className={`${orderDetails.isDelivered ? "text-green-700 bg-green-100" : "text-Yellow-700 bg-yellow-100"} px-3 py-1 rounded-full text-sm font-medium mb-2`}>{orderDetails.isDelivered ? "Delivered" : "Pending Delivery "}
                        </span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <p>Address: {`${orderDetails.shippingAddress.city}, ${orderDetails.shippingAddress.country}`}
                        </p>
                    </div>
                </div>
                {/* Product List */}
