                ...
                */}
                <div className="hidden md:flex flex-col space-y-4 mr-6">
                    {selectedProduct.images.map((image, index) => (
                        <img
                         key={index} src={image.url} alt={image.altText || `Thumbnail ${index}` }
                ...
                <div className="md:w-1/2">
                    ...
                    {selectedProduct.images.map((image, index) => (
                        <img
                         key={index} src={image.url} alt={image.altText || `Thumbnail ${index}` }
                            className={`w-20 h-20 object-cover rounded-lg cursor-pointer border ${mainImage === image.url ? "border-black" : "bordrr-gray-300" }`}
                            onClick = {() => setMainImage(image.url)}
                         />
                    ))}
                    </div>
                    ...
                    <div className="md:w-1/2 md:ml-10">
                        ...
                        <div className="mt-10 ext-gray-700 ">
