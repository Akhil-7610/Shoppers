  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {colors.map((color) => (
            ...
            key={color} className={`w-8 h-8 rounded-full border border-gray-300  cursor-pointer transition hover:scale-105 ${filters.color === color ? "ring-2  ring-blue-500" : "" }`} name="color" style={{backgroundColor: color.toLowerCase()}}></button>
          ))}
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        {sizes.map((size) => (
          <div className="flex items-center mb01" key={size}>
            <input 
            value={size}
            onChange={handleFilterChange}
      ...
      <div className="mb-6">
        ...
        {materials.map((material) => (
          <div className="flex items-center mb01" key={material}>
            <input 
            onChange={handleFilterChange}
       ...
       <div className="mb-6">
        ...
        {brands.map((brand) => (
          <div className="flex items-center mb01" key={brand}>
            <input 
            value={brand}
            onChange={handleFilterChange}
